...
safety nets from the teleoperation literature catch the worst case. What seems to be
...
energy-based safety controller — the learned prediction is only used when it has
earned it.
